...
if (!html.includes('id="managerPayoutQueue"') || !html.includes('id="managerSupplyRecords"') || html.includes('id="payoutQueue"') || !js.includes('data-select-all-payouts') || !js.includes('data-action="settle-selected"') || !js.includes('#managerPayoutQueue') || !js.includes('if (!state.adminCode) return ""') || !js.includes('selectedPayouts') || !js.includes('supplyQueueActions') || !js.includes('mutateWith(async function') || !js.includes('settleSupply') || !backend.includes('"settleSale"') || !backend.includes('"settleSupply"') || !backend.includes('"settlePayouts"') || !backend.includes('settlePayouts_') || !backend.includes('paidAt') || !backend.includes('withLock_') || !backend.includes("assertAdmin_(body.adminCode)")) {
