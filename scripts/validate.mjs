...
if (!html.includes('id="managerPayoutQueue"') || html.includes('id="payoutQueue"') || !js.includes('data-select-all-payouts') || !js.includes('data-action="settle-selected"') || !js.includes('#managerPayoutQueue') || !js.includes('if (!state.adminCode) return ""') || !js.includes('selectedPayouts') || !js.includes('mutateWith(async function') || !js.includes('request("settleSale"') || !backend.includes('"settleSale"') || !backend.includes('"settlePayouts"') || !backend.includes('settlePayouts_') || !backend.includes('withLock_') || !backend.includes("assertAdmin_(body.adminCode)")) {
